...
export const ScrollTimeline = ({
  ...
  // Define yOffset at component level (not inside map callback)
  ...
  const getConnectorClasses = () => {
    // Keep visual styling here, but positioning will be handled inline when rendering
    const baseClasses = cn(lineColor);
  ...
  return (
    <div
      ...
      style={{ minHeight: `${events.length * 400 + 400}px` }} // Ensure enough scroll height
    >
            ...
            {events.map((event, index) => {
              return (
                <div
                  ...
                  className={cn(
                    "relative flex items-center mb-52 py-4",
